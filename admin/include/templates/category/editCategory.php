      ...
      <div class="flex justify-center w-full items-center md:gap-10 sm:gap-0 flex-col-reverse md:flex-row">
        <div class="mt-5 w-[90%] sm:w-full sm:max-w-sm">
          <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            <form action="categories.php?from=<?php echo $from ?>&do=edit&id=<?php echo $category['id'] ?>" method="POST">
        <h2 class="mb-5 text-center text-2xl/9 font-bold tracking-tight text-gray-700 dark:text-gray-200">Edit Category</h2>
        <div class="text-sm text-red-700 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
          ...
          <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              <div class="col-span-2">
                <input data-required required  id="categoryName" name="name" placeholder="Category Name" value="<?php echo $category['name']; ?>" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
              </div>

              <div class="col-span-2">
                <textarea data-required required  id="description" rows="4"   name="description" placeholder="Write your Description here..." class="min-h-[100px] block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"><?php echo $category['description']; ?></textarea>
              </div>
              ...
              <div class="col-span-2">
                <select id="visibility" required  name="visibility" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                  ...
                  <option value="1"  <?php echo $category['visibility'] == 1?'selected':''?> >Visible</option>
                  <option value="0"  <?php echo $category['visibility'] == 0?'selected':''?> >Invisible</option>
                </select>
              </div>
          </div>
