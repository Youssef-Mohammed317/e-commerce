<div class="flex justify-center items-center mt-5 flex-col">
  <p class="text-2xl text-red-600 text-center mb-5">Are you sure you want to delete This Item</p>
  <form action="items.php?from=<?php echo $from ?>&do=delete&id=<?php echo $id ?>" method="post" class="">
