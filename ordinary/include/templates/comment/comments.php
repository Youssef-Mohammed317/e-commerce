        ...
        <tbody>
            ...
            ?>
                ...
                <td class="px-4 py-3">
                    ...
                    <a href="comments.php?from=<?php echo $from ?>&do=change-status&id=<?php echo $comment['id'] ?>" class="font-medium text-gray-400 hover:underline"><?php echo $comment['status'] == 1 ? 
                    ...
                    <a href="comments.php?from=<?php echo $from ?>&do=edit&id=<?php echo $comment['id'] ?>" class="font-medium text-blue-600 hover:underline">
                    ...
                    <a href="comments.php?from=<?php echo $from ?>&do=delete&id=<?php echo $comment['id'] ?>" class="font-medium text-[20px] text-red-600 hover:underline">
