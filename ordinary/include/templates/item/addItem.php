<div class="flex min-h-full w-full flex-col justify-start px-6 py-8 lg:px-8 mb-[100px]">
  ...
  <form action="items.php?&do=add" method="POST" class="item-fields" enctype="multipart/form-data">
  ...
  <div class="text-sm text-red-700 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                <span class="font-medium">Danger alert!</span> <span class="mx-1" style="color:red;">*</span> For Required Fields.
              </div>

<div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
          <div class="col-span-2">
            <input id="itemName"  data-required  required  name="name"  placeholder="Item Name" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
          </div>
          ...
          <div class="col-span-2">
            <input type="number" data-required  required   name="price" id="price"  placeholder="Item Price" class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
          </div>

          <div class="col-span-2" >
            <select id="country" name="country" data-required required  class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
          ...
          <div class="col-span-2">
            <select id="status" name="status" data-required required class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
          ...
          <div class="col-span-2">
            <select id="category" name="category" required data-required=""  class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
        ...
        <div class="py-7">
          <span id="" data-required  onclick="document.getElementById('add-image-ordinary').click()" class=" cursor-pointer px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-blue-700 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Upload Image</span>
          <input name="image" id="add-image-ordinary" class="hidden w-full mb-5 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="default_size" type="file">
        </div>
        <div class="flex justify-between mt-6 flex-col sm:flex-row-reverse sm:gap-0 gap-4">
          ...
          <a href="items.php" name="submit" value="cancel" class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Cancel</a>
        </div>
      </form>
    </section>
    <section class="item-preview max-w-4xl md:w-[90%] p-6 mx-auto flex justify-center items-center bg-white rounded-md shadow-md dark:bg-gray-800">
      <div class="w-full mx-auto flex flex-col justify-between max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div>
          <a href="#">
          <img id="image-field" class="p-8 rounded-t-lg w-full" src="<?php echo '../assets/imgs/product-image.png' ?>" alt="product image" />
          </a>
        </div>
