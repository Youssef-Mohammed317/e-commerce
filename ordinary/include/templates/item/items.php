...
<div class="flex justify-end items-center">
    <a href="items.php?do=add" class="flex items-center font-medium px-4 py-3 bg-gray-500 dark:bg-[#1f2937] hover:bg-[#2f3947] text-white rounded-lg mx-3 my-2">
...
<?php if(count($items) == 0) { ?>
  ...
  <?php } elseif (count($items) == 1) {
    ...
    ?>
                <div class=" mb-6 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 bg-white dark:bg-gray-800">
                  <figure class="grid grid-cols-1 md:grid-cols-2 p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:bg-gray-800 dark:border-gray-700">
                    <div class="max-w-2xl mx-auto text-gray-500 dark:text-gray-400 flex flex-col justify-center items-center">
                      <div class="flex items-center justify-center">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Name:</h3>
                        <p class="ms-3"><?php echo $item['name'] ?></p>
                      </div>
                      <div class="flex items-center justify-center my-2 flex-col">
                      ...
                      <div class="flex mt-2 items-center justify-center">
                        ...
                        <a class=" ms-3 font-medium text-gray-500 dark:text-gray-400">
                      ...
                      <div class="flex items-center justify-center">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Total Comments:</h3>
                        <p class="ms-3"><?php echo count(select('id','comments','where item_id = ' . $item['item_id'])) ?></p>
                      </div>
                      <a href="items.php?do=viewItem&id=<?php echo $item['item_id']?>" class="block text-gray-500 text-[15px] font-semibold hover:underline hover:text-sky-600 px-3 py-1.5 rounded-md">Show Item</a> 
                    ...
                    <div class="max-w-2xl mx-auto text-gray-500 dark:text-gray-400 ">
                      <div class="w-full mx-auto flex flex-col justify-between max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div>
                          <a href="items.php?do=viewItem&id=<?php echo $item['item_id']?>">
                            ...
                            <div class="flex items-center justify-between">
                              ...
                              <div class="flex items-center gap-2">
                                <?php 
                                  ...
                                  <?php } else {?>
                                    <a href="" class="px-3 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-yellow-700 rounded-md hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600">
                                      Add To Cart
                                    </a>
                                  <?php }?>
                              </div>
        ...
        <tbody>
            ...
            ?>
              <tr class="<?php echo $item['approved'] == 0 ?'opacity-[0.95] line-through' : '' ?> details light:odd:bg-white light:even:bg-gray-100 border-b dark:odd:bg-gray-800 dark:odd:border-gray-700  dark:even:border-gray-600   dark:even:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white light:text-gray-800 md:text-[20px]">
                ...
                <td class="px-4 py-3 hidden lg:table-cell">
                    <a class="font-medium text-gray-400 hover:underline">
                      <?php echo $item['approved'] == 1 ? 'Approved' : 'Unapproved'?>
                    </a>
                </td>
                <td class="px-4 py-3">
                    <div class="flex items-center justify-end">
                    <a href="items.php?do=edit&id=<?php echo $item['item_id']?>" class="font-medium text-blue-600 hover:underline" data-toolTip="Edit">
                    ...
                    <a href="items.php?do=checkDelete&id=<?php echo $item['item_id']?>" onclick="<?php $_SESSION['item_id'] = $item['item_id']?>" data-toolTip="Delete" class="font-medium text-[20px] text-red-600 hover:underline">
