<div class="flex justify-center items-center mt-5 flex-col">
  <p class="text-2xl text-red-600 text-center mb-5">Are you sure you want to delete your profile</p>
  <form action="profile.php?do=delete&id=<?php echo $_SESSION['userid']?>" method="post" class="">
